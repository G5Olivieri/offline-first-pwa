...
describe('App Component', () => {
  ...
  describe('Barcode Functionality', () => {
    it('should add product when valid barcode is entered', async () => {
      ...
      expect(mockProductStore.findProductByBarcode).toHaveBeenCalledWith('123456789');
  ...
  describe('Store Management', () => {
    ...
    it('should clear customer', async () => {
      ...
      expect(mockNotificationStore.showInfo).toHaveBeenCalledWith('Customer cleared');
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle system initialization errors', async () => {
      ...
      // The error should be logged, but we can't easily test this without accessing the logger mock
