            ...
            <div class="mb-8">
              ...
              <div class="space-y-3">
                <div class="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                  ...
                  <p class="text-indigo-700 text-sm">Press <kbd class="px-1 py-0.5 bg-white border border-indigo-300 rounded text-xs font-mono">Esc</kbd> to close this help dialog quickly, or click outside the dialog area.</p>
                </div>
