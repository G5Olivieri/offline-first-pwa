<template>
  <div class="animate-pulse">
    <div v-if="type === 'product-card'" class="space-y-3">
      ...
      <div class="space-y-2">
        ...
        <div class="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-1/3"></div>
      </div>
    </div>

    <div v-else-if="type === 'order-item'" class="flex items-center space-x-4 p-4">
      <div class="w-12 h-12 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg"></div>
      <div class="flex-1 space-y-2">
        <div class="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-1/2"></div>
    ...
    <div v-else-if="type === 'customer-card'" class="space-y-3 p-4">
      <div class="flex items-center space-x-3">
        <div class="w-10 h-10 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full"></div>
        <div class="flex-1 space-y-2">
...
interface Props {
  type?: 'default' | 'product-card' | 'order-item' | 'customer-card'
}
