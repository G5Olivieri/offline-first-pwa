...
const displayProducts = computed(() => props.products.slice(0, config.maxSuggestions));
...
<template>
  <div v-if="displayProducts.length > 0">
    <div class="mb-8 text-center">
      ...
      <p v-if="subtitle" class="text-gray-600 max-w-2xl mx-auto">{{ subtitle }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="absolute top-4 right-4">
          <div :class="product.stock > 10 ? 'bg-green-500' : product.stock > 0 ? 'bg-yellow-500' : 'bg-red-500'"
        ...
        <div class="relative z-10 flex flex-col h-full">
          <div class="flex-1 mb-4">
            <h4 class="font-bold text-gray-800 text-base mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">
              {{ product.name }}
            </h4>
            ...
            <div class="flex items-center justify-between mb-3">
              ...
              <div class="text-right">
                ...
                <p :class="product.stock > 10 ? 'text-green-600' : product.stock > 0 ? 'text-yellow-600' : 'text-red-600'"
