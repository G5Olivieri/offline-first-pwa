    ...
    <div class="max-w-md w-full text-center">
      ...
      <div class="mb-8">
        <svg class="mx-auto h-32 w-32 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 014 12H0l3-3m1 8.291A7.962 7.962 0 0120 12h4l-3-3" />
        </svg>
      </div>
      ...
      <div v-if="isDevelopment" class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-left">
        <h4 class="text-sm font-medium text-yellow-800 mb-2">Debug Info (Development Mode)</h4>
...
const goHome = async () => {
  try {
    await router.push('/');
    notificationStore.showSuccess('Navigation', 'Successfully returned to home page');
  } catch (error) {
