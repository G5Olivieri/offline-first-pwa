            ...
            <div v-if="hasAdditionalInfo" class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div class="p-6 space-y-4">
                ...
                <div v-if="hasPharmaceuticalInfo" class="space-y-4">
                  <h4 class="font-medium text-gray-700">Pharmaceutical Details</h4>

                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div v-if="product.prescriptionStatus" class="p-3 bg-yellow-50 rounded-lg">
                      <span class="font-medium text-gray-700 block mb-2">Prescription Status</span>
                      <span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-medium">
                        {{ product.prescriptionStatus }}
                      </span>
                    </div>

                    <div v-if="product.dosageForm" class="p-3 bg-gray-50 rounded-lg">
                      <span class="font-medium text-gray-700 block mb-2">Dosage Form</span>
                      <span class="text-gray-800 bg-white px-3 py-1 rounded text-sm">{{ product.dosageForm }}</span>
                    </div>

                    <div v-if="product.drugClass" class="p-3 bg-purple-50 rounded-lg">
                      <span class="font-medium text-gray-700 block mb-2">Drug Class</span>
                      <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">{{ product.drugClass }}</span>
                    </div>

                    <div v-if="product.isProprietary !== undefined" class="p-3 bg-gray-50 rounded-lg">
                      <span class="font-medium text-gray-700 block mb-2">Type</span>
                      <span
                        class="px-3 py-1 rounded-full text-sm font-medium"
                        :class="{
                  ...
                  <div v-if="product.activeIngredient" class="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <h5 class="font-medium text-orange-800 mb-2">Active Ingredient</h5>
                  ...
                  <div v-if="product.contraindication" class="p-4 bg-red-50 rounded-lg border border-red-200">
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        <h5 class="font-medium text-red-800 mb-2">Contraindication Warning</h5>
