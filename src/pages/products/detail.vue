    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="error" class="text-center py-12">
        <div class="bg-red-50 rounded-lg p-8 max-w-md mx-auto">
          ...
          <h2 class="text-xl font-semibold text-red-800 mb-2">Product Not Found</h2>
      ...
      <div v-else-if="product" class="space-y-8">
            ...
            <div class="flex items-center gap-3">
              ...
              <div
                ...
                :class="{
                  ...
                  'bg-yellow-100 text-yellow-700': product.stock > 0 && product.stock <= 10,
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div class="p-6 space-y-6">
                ...
                <div>
                  ...
                  <p v-if="product.nonProprietaryName && product.nonProprietaryName !== product.name"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex items-center justify-between">
                      <span class="font-mono text-lg">{{ product.barcode }}</span>
                      <button
                  ...
                  <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <span class="font-mono text-sm text-gray-800">{{ product._id }}</span>
                  </div>
                </div>

                <!-- Description -->
                <div v-if="product.description" class="bg-gray-50 rounded-lg p-4">
            ...
            <div v-if="hasPharmaceuticalInfo" class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
                <h2 class="text-xl font-semibold text-white">Pharmaceutical Information</h2>
              </div>
              <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <!-- Prescription Status -->
                  <div v-if="product.prescriptionStatus" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span class="font-medium text-gray-700">Prescription Status:</span>
                    <span
                      class="px-3 py-1 rounded-full text-sm font-medium"
                      :class="{
                        'bg-red-100 text-red-700': product.prescriptionStatus === 'PrescriptionOnly'
                      }"
                    >
                      {{ product.prescriptionStatus === 'PrescriptionOnly' ? 'Prescription Only' : product.prescriptionStatus }}
                    </span>
                  </div>

                  <!-- Dosage Form -->
                  <div v-if="product.dosageForm" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span class="font-medium text-gray-700">Dosage Form:</span>
                    <span class="text-gray-800 bg-white px-3 py-1 rounded-full text-sm">{{ product.dosageForm }}</span>
                  </div>

                  <!-- Drug Class -->
                  <div v-if="product.drugClass" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span class="font-medium text-gray-700">Drug Class:</span>
                    <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">{{ product.drugClass }}</span>
                  </div>

                  <!-- Proprietary Status -->
                  <div v-if="product.isProprietary !== undefined" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <!-- Active Ingredient -->
                <div v-if="product.activeIngredient" class="p-4 bg-orange-50 rounded-lg border border-orange-200">
                  <h4 class="font-medium text-orange-800 mb-2">Active Ingredient</h4>
                  <p class="text-orange-700">{{ product.activeIngredient }}</p>
                </div>

                <!-- Contraindication Warning -->
                <div v-if="product.contraindication" class="p-4 bg-red-50 rounded-lg border border-red-200">
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      <h4 class="font-medium text-red-800 mb-2">Contraindication Warning</h4>
                      <p class="text-red-700 leading-relaxed">{{ product.contraindication }}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div v-if="hasAdditionalInfo" class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div v-if="product.category" class="p-3 bg-gray-50 rounded-lg">
                    <span class="font-medium text-gray-700 block mb-2">Category</span>
                    <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">{{ product.category }}</span>
                  </div>

                  <div v-if="product.manufacturer" class="p-3 bg-gray-50 rounded-lg">
                    <span class="font-medium text-gray-700 block mb-2">Manufacturer</span>
                    <span class="text-gray-800 bg-white px-3 py-1 rounded text-sm">{{ product.manufacturer }}</span>
                  </div>
                </div>

                <!-- Tags -->
                <div v-if="product.tags && product.tags.length > 0" class="p-4 bg-gray-50 rounded-lg">
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div class="p-6 space-y-3">
                ...
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L4 3H2m5 10v6a1 1 0 001 1h10a1 1 0 001-1v-6m-4 3a1 1 0 11-2 0 1 1 0 012 0zm-6 0a1 1 0 11-2 0 1 1 0 012 0z"></path>
                  </svg>
            ...
            <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              <div class="bg-gradient-to-r from-purple-600 to-violet-600 px-6 py-4">
                <h2 class="text-xl font-semibold text-white">Related Products</h2>
              </div>
              <div class="p-6">
            ...
            <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              <div class="bg-gradient-to-r from-gray-600 to-slate-600 px-6 py-4">
                <h2 class="text-xl font-semibold text-white">Inventory Status</h2>
              </div>
              <div class="p-6 space-y-4">
                <div class="text-center">
                ...
                <div class="space-y-2">
                  ...
                  <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-gray-900">${{ (product.stock * product.price).toFixed(2) }}</span>
                  </div>
                </div>
